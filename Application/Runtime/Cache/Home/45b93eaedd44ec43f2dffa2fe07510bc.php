...
function worker_search() {
    ...
    <div class="container marketing pagebody">
        <div class="row">
          <h2><span style="color: #444444;"><?php echo (L("Who are you signing up as?")); ?></span></h2>
          <div class="col-lg-6">
            <h2><span style="color: #254467;"><?php echo (L("Requester Sign Up")); ?></span></h2>
            <div id="auth">
            <div class="well">
            <div class="heading">
                <h3><?php echo (L("Requester Sign Up")); ?></h3>
                <div class="already-have-account"><?php echo (L("Already have an account?")); ?>
                    <a href="<?php echo (C("WEB_URL")); ?>/Index/signin" class="switch-login"><?php echo (L("Sign In")); ?></a>
                </div>
            </div>
            <div class="authentication" id="new-requester-form">
                <div class="control-group string optional user_name">
                    <label class="string optional control-label" for="user_name"><?php echo (L("User Name")); ?>*</label>
                    <div class="controls">
                        <input class="string optional" id="user_name_requester" name="user[name]" placeholder="<?php echo (L("User Name")); ?>" size="40" type="text" onkeydown="subRSignupCheck();">
                    </div>
                </div>
                <div class="control-group email optional user_email">
                    <label class="email optional control-label" for="user_email"><?php echo (L("Email")); ?>*</label>
                    <div class="controls">
                        <input autocomplete="off" class="string email optional" id="user_email_requester" name="user[email]" placeholder="<?php echo (L("Email")); ?>" size="40" type="email" onkeydown="subRSignupCheck();">
                    </div>
                </div>
                <div class="control-group password optional user_password">
                    ...
                    <div class="controls">
                        <input class="password optional" id="user_password_requester" name="user[password]" pattern=".{8,128}" placeholder="<?php echo (L("Password")); ?> (min. 8 characters)" size="40" type="password" onkeydown="subRSignupCheck();">
                    </div>
                </div>
                <div class="control-group password optional user_password_confirmation">
                    <label class="password optional control-label" for="user_password_confirmation"><?php echo (L("Confirm Password")); ?>*</label>
                    <div class="controls">
                        <input class="password optional" id="user_password_confirmation_requester" name="user[password_confirmation]" pattern=".{8,128}" placeholder="<?php echo (L("Confirm Password")); ?>" size="40" type="password" onkeydown="subRSignupCheck();">
                    </div>
                </div>
                <!--<div class="control-group string optional user_phone_number">
                    <label class="string optional control-label" for="user_phone_number"><?php echo (L("Phone")); ?></label>
                    <div class="controls">
                        <input class="string optional" id="user_phone_number_requester" name="user[phone_number]" placeholder="<?php echo (L("Phone")); ?> (<?php echo (L("Optional")); ?>)" size="40" type="text">
                    </div>
                </div>
                <div class="control-group string optional user_title">
                    <label class="string optional control-label" for="user_title"><?php echo (L("Title")); ?></label>
                    <div class="controls">
                        <input class="string optional" id="user_title_requester" name="user[title]" placeholder="<?php echo (L("Title")); ?> (<?php echo (L("Optional")); ?>)" size="40" type="text">
                    </div>
                </div>-->
                <div class="form-actions">
                    <button class="btn btn-primary" name="commit" id="requester_signup" value="Start Free Trial"><?php echo (L("Start Free Trial")); ?></button>
                </div>
            </div>
        </div>
    </div>
          ...
          <div class="col-lg-6">
            <h2><span style="color: #00ab4d;"><?php echo (L("Worker Sign Up")); ?></span></h2>
            <div id="auth">
            <div class="well">
            <div class="heading">
                <h3><?php echo (L("Worker Sign Up")); ?></h3>
                <div class="already-have-account"><?php echo (L("Already have an account?")); ?>
                    <a href="<?php echo (C("WEB_URL")); ?>/Index/signin" class="switch-login"><?php echo (L("Sign In")); ?></a>
                </div>
            </div>
            <div class="authentication" id="new-worker-form">
                <div class="control-group string optional user_name">
                    <label class="string optional control-label" for="user_name"><?php echo (L("User Name")); ?>*</label>
                    <div class="controls">
                        <input class="string optional" id="user_name_worker" name="user[name]" placeholder="<?php echo (L("User Name")); ?>" size="40" type="text" onkeydown="subWSignupCheck();">
                    </div>
                </div>
                <div class="control-group email optional user_email">
                    <label class="email optional control-label" for="user_email"><?php echo (L("Email")); ?>*</label>
                    <div class="controls">
                        <input autocomplete="off" class="string email optional" id="user_email_worker" name="user[email]" placeholder="<?php echo (L("Email")); ?>" size="40" type="email" onkeydown="subWSignupCheck();">
                    </div>
                </div>
                <div class="control-group password optional user_password">
                    <label class="password optional control-label" for="user_password"><?php echo (L("Password")); ?>*</label>
                    <div class="controls">
                        <input class="password optional" id="user_password_worker" name="user[password]" pattern=".{8,128}" placeholder="<?php echo (L("Password")); ?> (min. 8 characters)" size="40" type="password" onkeydown="subWSignupCheck();">
                    </div>
                </div>
                <div class="control-group password optional user_password_confirmation">
                    <label class="password optional control-label" for="user_password_confirmation"><?php echo (L("Confirm Password")); ?>*</label>
                    <div class="controls">
                        <input class="password optional" id="user_password_confirmation_worker" name="user[password_confirmation]" pattern=".{8,128}" placeholder="<?php echo (L("Confirm Password")); ?>" size="40" type="password" onkeydown="subWSignupCheck();">
                    </div>
                </div>
                <!--<div class="control-group string optional user_phone_number">
                    <label class="string optional control-label" for="user_phone_number"><?php echo (L("Phone")); ?></label>
                    <div class="controls">
                        <input class="string optional" id="user_phone_number_worker" name="user[phone_number]" placeholder="<?php echo (L("Phone")); ?> (<?php echo (L("Optional")); ?>)" size="40" type="text">
                    </div>
                </div>
                <div class="control-group string optional user_title">
                    <label class="string optional control-label" for="user_title"><?php echo (L("Title")); ?></label>
                    <div class="controls">
                        <input class="string optional" id="user_title_worker" name="user[title]" placeholder="<?php echo (L("Title")); ?> (<?php echo (L("Optional")); ?>)" size="40" type="text">
                    </div>
                </div>-->
                <div class="form-actions">
                    <button class="btn btn-primary" name="commit" id="worker_signup" value="Start Free Trial"><?php echo (L("Start Free Trial")); ?></button>
                </div>
            </div>
        </div>
    </div>
